...
export class FavoritesService {
  ...
  deleteFavoriteByArticleIdAndUserId(articleId: number,userId:number): Observable<any> {
    return this.httpClient.delete<any>(this.baseUrl + `articulo/${articleId}/usuario/${userId}`);
  }
}
